...
Динамическая сложность: чем больше участников (разных майнеров) в сети, тем
выше сложность — каждые 2 новых майнера добавляют +1 ведущий ноль в хеш блока.
Сложность каждого блока записана в его заголовок и проверяется всеми узлами.
...
Автотесты (49 тестов: кошелёк, транзакции, блокчейн, узел, экономика, API):
