...
Эмиссия как у Bitcoin: за блок майнер получает строго 50 BHY, и каждые 4 года
(310 000 блоков при времени блока ~6.8 мин) награда делится пополам — 50 → 25 →
12.5 … Потолок 31 000 000 BHY, выпуск конечен и завершается примерно в 2162 году.
...
Структура проекта — ядро оформлено как Python-пакет b_hydra/:
    ...
    b_hydra/
      ...
      economics.py           — награда, халвинг, конец эмиссии (2162)
