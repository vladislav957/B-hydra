...
# Целевое время блока подобрано так, чтобы майнинг закончился в TARGET_END_YEAR.
BLOCK_TIME_SECONDS = ((TARGET_END_YEAR - GENESIS_YEAR) * SECONDS_PER_YEAR
                      / MINING_END_HEIGHT)
TARGET_BLOCK_TIME = BLOCK_TIME_SECONDS   # к этому времени стремится ретаргетинг
