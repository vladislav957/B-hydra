...
# Версия живёт в version.py: её же разбирает обновлятель, и два места
# для одного числа неминуемо разъехались бы (здесь стояло 0.0.2, когда в
# релизах была уже v0.1.0).
