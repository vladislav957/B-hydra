...
python -m pytest -q                           # 293 теста — держать зелёными
...
`tests/` (22 файла, 293 теста, `pytest`). Полная карта слоёв — `ARCHITECTURE.md`,
...
- **Перед push — `python -m pytest -q` должно быть зелёным** (293/293).
