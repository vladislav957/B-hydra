...
python -m pytest -q                           # 271 тест — держать зелёными
...
`tests/` (22 файла, 271 тест, `pytest`). Полная карта слоёв — `ARCHITECTURE.md`,
...
- **Перед push — `python -m pytest -q` должно быть зелёным** (271/271).
