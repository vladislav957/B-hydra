...
python -m pytest -q                           # 303 теста — держать зелёными
...
`tests/` (22 файла, 303 теста, `pytest`). Полная карта слоёв — `ARCHITECTURE.md`,
...
- **Перед push — `python -m pytest -q` должно быть зелёным** (303/303).
