...
python -m pytest -q                           # 281 тест — держать зелёными
...
`tests/` (22 файла, 281 тест, `pytest`). Полная карта слоёв — `ARCHITECTURE.md`,
...
- **Перед push — `python -m pytest -q` должно быть зелёным** (281/281).
