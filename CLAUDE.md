...
python -m pytest -q                           # 264 теста — держать зелёными
...
`tests/` (22 файла, 264 теста, `pytest`). Полная карта слоёв — `ARCHITECTURE.md`,
...
- **Перед push — `python -m pytest -q` должно быть зелёным** (264/264).
